...
\begin{itemize}
    ...
    \lstinputlisting[language = java]{replaceConstructorWithFactoryMethodProblem.java}
    \item \textbf{Solución}: Crear un método de fábrica y usarlo en vez de las llamadas al constructor.
    \lstinputlisting[language = java]{replaceConstructorWithFactoryMethodSolution.java}
\end{itemize}
...
\begin{itemize}
    ...
    \lstinputlisting[language = java]{replaceControlFlagWithBreakProblem.java}
    \item \textbf{Solución}: Usar un break en vez de la variable booleana
    \lstinputlisting[language = java]{replaceControlFlagWithBreakSolution.java}
\end{itemize}
...
\begin{itemize}
    ...
    \lstinputlisting[language = java]{replaceDerivedVariableWithQueryProblem.java}
    \item \textbf{Solución}: Emplezar una consulta
    \lstinputlisting[language = java]{replaceDerivedVariableWithQuerySolution.java}
\end{itemize}
...
\begin{itemize}
    ...
    \lstinputlisting[language = java]{replaceExceptionWithPrecheckProblem.java}
    \item \textbf{Solución}: Emplezar una condición en vez de una excepción.
    \lstinputlisting[language = java]{replaceExceptionWithPrecheckSolution.java}
\end{itemize}
...
\begin{itemize}
    ...
    \lstinputlisting[language = java]{replaceFunctionWithCommandProblem.java}
    \item \textbf{Solución}: Emplear una clase para realizar la función completa en varias partes.
    \lstinputlisting[language = java]{replaceFunctionWithCommandSolution.java}
\end{itemize}
...
\begin{itemize}
    ...
    \lstinputlisting[language = java]{replaceInlineCodeWithFunctionCallProblem.java}
    \item \textbf{Solución}: Empleamos una función existente en vez de codificarla.
    \lstinputlisting[language = java]{replaceInlineCodeWithFunctionCallSolution.java}
\end{itemize}
...
\begin{itemize}
    ...
    \lstinputlisting[language = java]{replaceSuperclassWithDelegateProblem.java}
    ...
    \lstinputlisting[language = java]{replaceSuperclassWithDelegateSolution.java}
\end{itemize}
...
\begin{itemize}
    ...
    \lstinputlisting[languaje = java]{replaceTypeCodeWithSubclassesProblem.java}
    
    \item \textbf{Solución} Se crean subclases que serán llamados según el tipo de objeto que se quiera crear.
    \lstinputlisting[language = java]{replaceTypeCodeWithSubclassesSolution.java}
\end{itemize}
...
\begin{itemize}
    ...
    \lstinputlisting[languaje = javascript]{returnModifiedValueProblem.java}
    ...
    \lstinputlisting[languaje = javascript]{returnModifiedValueSolution.java}
\end{itemize}
...
\begin{itemize}
    ...
    \lstinputlisting[languaje = javascript]{slideStatementsProblem.js}
    ...
    \lstinputlisting[languaje = javascript]{slideStatementsSolution.js}
\end{itemize}
...
\begin{itemize}
    ...
    \lstinputlisting[languaje = javascript]{splitLoopProblem.js}
    ...
    \lstinputlisting[languaje = javascript]{splitLoopSolution.js}
\end{itemize}
...
\begin{itemize}
    ...
    \lstinputlisting[languaje = javascript]{splitPhaseProblem.js}
    ...
    \lstinputlisting[languaje = javascript]{splitPhaseSolution.js}
\end{itemize}
...
\begin{itemize}
    ...
    \lstinputlisting[laguaje = javascript]{splitVariableProblem.js}
    
    \item \textbf{Solución} Se crean constantes que almacenarán los resultados significativos o importantes
    \lstinputlisting[laguaje = javascript]{splitVariableSolution.js}
\end{itemize}
...
\newline
  ...
  \lstinputlisting[language = java]{case2CalcularSalida.java} 
...
\textbf{Refactorizador:} Francisco José Martín \newline
    ...
    \lstinputlisting[language = java]{alumno3LongMethod.java}
    \newline
    ...
    \lstinputlisting[language = java]{alumno3LongMethod2.java}
    \newline
    ...
    \lstinputlisting[language = java]{alumno3RenameField.java}
    \newline
    ...
    \lstinputlisting[language = java]{alumno3ExtractMethod.java}
    \newline
...
\chapter {Caso 5: Adalid Abraham Villanueva Hermoza}
    ...
    \lstinputlisting[language = java]{alumno5LongMethod.java}
    
    \hyperref[deadcode]{\textbf{Dead Code}}
    \newline
    \textbf{Razón}: El constructor de la clase Caravana está vacío.
    \lstinputlisting[language = java]{alumno5DeadCode.java}
    ...
    \lstinputlisting[language = java]{alumno5scanner.java}
    ...
    \lstinputlisting[language = java]{alumno5excepciones.java}
...
\hyperref[extractmethod]{\textbf{Extract Method}}
    ...
    \lstinputlisting[language = py]{alumno6ExtractMethod.py}
    ...
    \lstinputlisting[language = py]{alumno6ExtractMethod2.py}
